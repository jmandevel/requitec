...
enum class TokenType {
  ...
  LEFT_TUPLE_TYPE_GROUPING,      // {|
  RIGHT_TUPLE_TYPE_GROUPING,     // |}
  ...
  ERROR_UNMATCHED_LEFT_TUPLE_TYPE_GROUPING,
  ERROR_UNMATCHED_RIGHT_TUPLE_TYPE_GROUPING
};
