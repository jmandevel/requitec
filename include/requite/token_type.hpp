...
enum class TokenType {
  ...
  DOUBLE_DOT_DOUBLE_EQUAL_OPERATOR,  // ..==
  DOUBLE_DOT_BANG_EQUAL_OPERATOR,    // ..!=
  DOUBLE_DOT_GREATER_OPERATOR,       // ..>
  DOUBLE_DOT_GREATER_EQUAL_OPERATOR, // ..>=
...
getDescription(requite::TokenType token);
...
[[nodiscard]] constexpr bool getIsErrorLiteral(requite::TokenType token);
[[nodiscard]] constexpr bool getIsTacitTerminator(requite::TokenType token);
