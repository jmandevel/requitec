...
enum _CharFlags : std::uint16_t {
  ...
  _CHAR_FLAGS_COLON = _CHAR_FLAG_SYMBOL,
  _CHAR_FLAGS_SEMICOLON = _CHAR_FLAG_SYMBOL,
  _CHAR_FLAGS_OPEN_ANGLE = _CHAR_FLAG_SYMBOL,
  _CHAR_FLAGS_EQUAL = _CHAR_FLAG_SYMBOL,
  _CHAR_FLAGS_CLOSE_ANGLE = _CHAR_FLAG_SYMBOL,
  _CHAR_FLAGS_QUESTION = (_CHAR_COMMON_FLAGS_DIGIT_SYMBOL | 63),
  ...
  _CHAR_FLAGS_BACK_SLASH = (_CHAR_COMMON_FLAGS_DIGIT_SYMBOL | 62),
