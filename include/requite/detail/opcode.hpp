...
enum _OpcodeFlags : std::uint32_t {
  ...
  _MATTE_MODULE_STATEMENT = requite::getBit(4),
  _MATTE_TABLE_STATEMENT = requite::getBit(5),
  _MATTE_OBJECT_STATEMENT = requite::getBit(6),
  _MATTE_LOCAL_STATEMENT = requite::getBit(7),
  _VALUE_REFLECTIVE_LOCAL_STATEMENT = requite::getBit(8),
  _SYMBOL_REFLECTIVE_LOCAL_STATEMENT = requite::getBit(9),
...
_getFlags(requite::Opcode opcode) {
  ...
  case Opcode::__IDENTIFIER_LITERAL:
    return _INTERNAL_USE_ONLY | _BRANCH_CAN_HAVE_NO_SEMICOLON |
  ...
  case Opcode::IDENTIFY:
    return _BRANCH_CAN_HAVE_NO_SEMICOLON | _MATTE_DESTINATION |
           _VALUE_REFLECTIVE_DESTINATION | _SYMBOL_REFLECTIVE_DESTINATION |
           _MATTE_VALUE | _VALUE_REFLECTIVE_VALUE | _SYMBOL_REFLECTIVE_VALUE |
           _MATTE_JUNCTION | _VALUE_REFLECTIVE_JUNCTION |
           _SYMBOL_REFLECTIVE_JUNCTION | _MATTE_SYMBOL |
  ...
  case Opcode::CONSTRUCTOR:
    return _BRANCH_CAN_HAVE_NO_SEMICOLON | _MATTE_OBJECT_STATEMENT;
  ...
  case Opcode::TABLE:
    return _BRANCH_CAN_HAVE_NO_SEMICOLON | _MATTE_MODULE_STATEMENT |
           _MATTE_TABLE_STATEMENT;
  case Opcode::_ALIAS:
    return _INTERMEDIATE_OPERATION | _MATTE_MODULE_STATEMENT |
           _MATTE_TABLE_STATEMENT | _MATTE_OBJECT_STATEMENT |
           _MATTE_LOCAL_STATEMENT;
  case Opcode::USE:
    return _BRANCH_CAN_HAVE_NO_SEMICOLON | _MATTE_MODULE_STATEMENT | _MATTE_TABLE_STATEMENT |
           _MATTE_OBJECT_STATEMENT | _MATTE_LOCAL_STATEMENT;
