...
constexpr requite::Opcode getUniversalizedValue(requite::Opcode opcode) {
  ...
  case requite::Opcode::EXPAND_MACRO:
    return requite::Opcode::_EXPAND_MACRO_VALUE;
  case requite::Opcode::BAKE:
...
constexpr bool getHasSituationData(requite::Opcode opcode) {
  return opcode == requite::Opcode::_EXPAND_MACRO_VALUE;
}
