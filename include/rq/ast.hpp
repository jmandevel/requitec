...
enum class KeywordFlags : std::uint32_t {
  ...
  HAS_SEMICOLON_SEPARATED_BRANCHES = rq::getBit(25),
  NULLARY_WHEN_NO_BRANCHES = rq::getBit(24),
  ...
  ENUMERATION_VALUE = rq::getBit(14),
  PATH = rq::getBit(13),
  NAME = rq::getBit(12),
...
getFlags(rq::Keyword keyword) {
  ...
  case K::_DROP_VALUE:
    return KF::SYMBOLIC | KF::LOCAL_STATEMENT | KF::TOP_STATEMENT |
           KF::TABLE_STATEMENT | KF::OBJECT_STATEMENT;
  case K::ENTRY_POINT:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES | KF::TOP_STATEMENT | KF::RVALUE;
  case K::FUNCTION:
  ...
  case K::CONSTRUCTOR:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES |
           KF::NULLARY_WHEN_NO_BRANCHES | KF::OBJECT_STATEMENT | KF::REFLECTION | KF::RVALUE | 2;
  case K::_CONSTRUCTOR_OF:
    return KF::SYMBOLIC | KF::RVALUE;
  case K::LAYOUT_CONSTRUCTOR:
  ...
  case K::DESTRUCTOR:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES |
           KF::NULLARY_WHEN_NO_BRANCHES | KF::OBJECT_STATEMENT | KF::REFLECTION | KF::RVALUE;
  case K::_DESTRUCTOR_OF:
    return KF::SYMBOLIC | KF::RVALUE;
  case K::CALLER:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES |
           KF::NULLARY_WHEN_NO_BRANCHES | KF::OBJECT_STATEMENT | KF::REFLECTION | KF::RVALUE | 1;
  case K::_CALLER_OF:
    return KF::SYMBOLIC | KF::RVALUE;
  case K::RANGER:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES |
  ...
  case K::OBJECT:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES |
           ...
           KF::LOCAL_STATEMENT | KF::REFLECTION | KF::RVALUE | 2;
  case K::_OBJECT_OF:
    return KF::SYMBOLIC | KF::RVALUE;
  case K::ENUMERATION:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES | KF::TOP_STATEMENT |
           KF::TABLE_STATEMENT | KF::OBJECT_STATEMENT | KF::LOCAL_STATEMENT | KF::REFLECTION | KF::RVALUE | 2;
  case K::_ENUMERATION_OF:
    return KF::SYMBOLIC | KF::RVALUE;
  case K::_ENUMERATION_VALUE_WITH_DISCRIMINANT:
  ...
  case K::SCOPE:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES | KF::LOCAL_STATEMENT |
           KF::TOP_STATEMENT | KF::TABLE_STATEMENT | KF::OBJECT_STATEMENT | KF::REFLECTION | KF::RVALUE;
  case K::INLINE_SCOPE:
    return KF::HAS_SEMICOLON_SEPARATED_BRANCHES | KF::RVALUE | 1;
  case K::_SCOPE_OF:
    return KF::SYMBOLIC | KF::RVALUE;
