...
getFlags(rq::Keyword keyword) {
  ...
  case K::CONSTRUCTOR:
    return KF::REFLECTION | KF::HAS_SEMICOLON_SEPARATED_BRANCHES | KF::NULLARY_WHEN_NO_BRANCHES |
           KF::OBJECT_STATEMENT | 2;
  case K::_CONSTRUCTOR_OF:
    return KF::SYMBOLIC | KF::RVALUE;
  case K::LAYOUT_CONSTRUCTOR:
    return KF::REFLECTION | KF::OBJECT_STATEMENT;
  case K::_LAYOUT_CONSTRUCTOR_OF:
    return KF::SYMBOLIC | KF::RVALUE;
  case K::DESTRUCTOR:
    return KF::REFLECTION | KF::HAS_SEMICOLON_SEPARATED_BRANCHES | KF::NULLARY_WHEN_NO_BRANCHES |
  ...
  // CONTROL FLOW
  case K::RETURN:
    return KF::LOCAL_STATEMENT | KF::TOP_STATEMENT |
           KF::TABLE_STATEMENT | KF::OBJECT_STATEMENT;
  case K::BREAK:
    return KF::LOCAL_STATEMENT | KF::TOP_STATEMENT |
           KF::TABLE_STATEMENT | KF::OBJECT_STATEMENT;
  ...
  case K::USE:
    return KF::TOP_STATEMENT | KF::TABLE_STATEMENT |
           KF::OBJECT_STATEMENT | KF::LOCAL_STATEMENT | KF::TOP_STATEMENT |
           KF::TABLE_STATEMENT | KF::OBJECT_STATEMENT;
  case K::USE_TABLE:
    return KF::TOP_STATEMENT | KF::TABLE_STATEMENT |
