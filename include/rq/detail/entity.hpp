...
[[nodiscard]] inline rq::OpcodeFlags getFlags(rq::Opcode opcode) {
  ...
  // POLYMORPHS
  case O::SY_FORWARD_RANGER_POLYMORPH:
    return OF::SYMBOL | OF::SY_POLYMORPH;
  case O::SY_BACKWARD_RANGER_POLYMORPH:
    return OF::SYMBOL | OF::SY_POLYMORPH;
  case O::SY_FUNCTION_POLYMORPH:
    return OF::SYMBOL | OF::SY_POLYMORPH;
  case O::SY_METHOD_POLYMORPH:
    return OF::SYMBOL | OF::SY_POLYMORPH;
  case O::SY_EXTENSION_METHOD_POLYMORPH:
    return OF::SYMBOL | OF::SY_POLYMORPH;
