...
void Context::prototype(requite::Module &module) {
...
void Context::prototype(requite::Object &object) {
  requite::Expression &expression = object.getExpression();
  this->logNotSupportedYet(expression);
  this->setNotOk();
}

void Context::prototype(requite::Procedure &procedure) {
...
void Context::prototype(requite::Alias &alias) {
  requite::Expression &expression = alias.getExpression();
  this->logNotSupportedYet(expression);
  this->setNotOk();
}

void Context::prototype(requite::Variable &variable) {
  requite::Expression &expression = variable.getExpression();
  this->logNotSupportedYet(expression);
  this->setNotOk();
}

void Context::prototype(requite::AnonymousFunction &anonymous_function) {
